...
<#
.SYNOPSIS
    Dry-run the Blackboard CurseForge release pipeline. Builds every loader, uploads NOTHING.
...
Write-Host "== Blackboard DRY RUN (no upload) - version $version ==" -ForegroundColor Cyan
